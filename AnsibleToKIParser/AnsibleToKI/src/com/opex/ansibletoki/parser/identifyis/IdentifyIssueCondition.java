...
public class IdentifyIssueCondition {
	String inputFile;
	Document dom;
	...
	public IdentifyIssueCondition(String inputFile, Document dom) {
		super();
	...
	private void setIssueCondition() {
		...
		Element issueCondition = getElmentByTagName("IssueCondition", dom.getDocumentElement());
		Element description = getElmentByTagName("Description", issueCondition);
		description.setTextContent(ansibleDocumentation.getDescription());
		Element andElement = getElmentByTagName("And", issueCondition);
